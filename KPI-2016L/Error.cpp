...
namespace Error
{
	ERROR_MESSAGE errors[ERROR_MAX_ENTRY] =											// описание ошибок
	{
		...
		ERROR_ENTRY(302, "[MA] Идентификатор не должен превышать 5 символов"),
		...
		ERROR_ENTRY(604, "[SA] Выражение составленно неверно"), ERROR_ENTRY_NODEF(605), ERROR_ENTRY_NODEF(606), ERROR_ENTRY_NODEF(607),
