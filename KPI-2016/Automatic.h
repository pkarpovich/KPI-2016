...
FST::FST fstStringLiterl("", 4,
	...
	FST::NODE(308,
		...
		FST::RELATION('ч', 1), FST::RELATION('ш', 1), FST::RELATION('щ', 1), FST::RELATION('ъ', 1),
		FST::RELATION('ы', 1), FST::RELATION('ь', 1), FST::RELATION('э', 1), FST::RELATION('ю', 1),
		FST::RELATION('я', 1), FST::RELATION('А', 1), FST::RELATION('Б', 1), FST::RELATION('В', 1),
		FST::RELATION('Г', 1), FST::RELATION('Д', 1), FST::RELATION('Е', 1), FST::RELATION('Ё', 1),
		FST::RELATION('Ж', 1), FST::RELATION('З', 1), FST::RELATION('И', 1), FST::RELATION('Й', 1),
		FST::RELATION('К', 1), FST::RELATION('Л', 1), FST::RELATION('М', 1), FST::RELATION('Н', 1),
		FST::RELATION('О', 1), FST::RELATION('П', 1), FST::RELATION('Р', 1), FST::RELATION('С', 1),
		FST::RELATION('Т', 1), FST::RELATION('У', 1), FST::RELATION('Ф', 1), FST::RELATION('Х', 1),
		FST::RELATION('Ц', 1), FST::RELATION('Ч', 1), FST::RELATION('Ш', 1), FST::RELATION('Щ', 1),
		FST::RELATION('Ъ', 1), FST::RELATION('Ы', 1), FST::RELATION('Ь', 1), FST::RELATION('Э', 1),
		FST::RELATION('Ю', 1), FST::RELATION('Я', 1), FST::RELATION('1', 1), FST::RELATION('2', 1),
		...
		FST::RELATION('я', 2), FST::RELATION('А', 2), FST::RELATION('Б', 2), FST::RELATION('В', 2),
		FST::RELATION('Г', 2), FST::RELATION('Д', 2), FST::RELATION('Е', 2), FST::RELATION('Ё', 2),
		FST::RELATION('Ж', 2), FST::RELATION('З', 2), FST::RELATION('И', 2), FST::RELATION('Й', 2),
		FST::RELATION('К', 2), FST::RELATION('Л', 2), FST::RELATION('М', 2), FST::RELATION('Н', 2),
		FST::RELATION('О', 2), FST::RELATION('П', 2), FST::RELATION('Р', 2), FST::RELATION('С', 2),
		FST::RELATION('Т', 2), FST::RELATION('У', 2), FST::RELATION('Ф', 2), FST::RELATION('Х', 2),
		FST::RELATION('Ц', 2), FST::RELATION('Ч', 2), FST::RELATION('Ш', 2), FST::RELATION('Щ', 2),
		FST::RELATION('Ъ', 2), FST::RELATION('Ы', 2), FST::RELATION('Ь', 2), FST::RELATION('Э', 2),
		FST::RELATION('Ю', 2), FST::RELATION('Я', 2), FST::RELATION('1', 2), FST::RELATION('2', 2),
...
FST::Automatic FST_ARRAY[] = {
	...
	{ fstStringLiterl, LEX_LITERAL,FN::LITERAL, LT::PN_DEF },
